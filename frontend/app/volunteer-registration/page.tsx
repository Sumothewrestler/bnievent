...
export default function VolunteerRegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.registered_by) {
      setMessage('Please select who is registering this Volunteer')
      setMessageType('error')
      return
    }
    ...
    try {
      const response = await fetch('https://api.bnievent.rfidpro.in/api/special-registration/', {
        ...
        body: JSON.stringify({ ...formData, registration_for: 'VOLUNTEERS' }),
      })
      ...
      if (response.ok && data.success) {
        ...
        setMessage(`Volunteer Registration successful! Ticket No: ${data.ticket_no}`)
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            color: '#f39c12', fontWeight: '600', fontSize: '14px',
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '35px' }}>
            ...
            <h2 style={{
              ...
              color: '#f39c12', fontFamily: "'Inter', sans-serif",
            }}>
              Volunteer Registration
            </h2>
            <p style={{ color: '#666', margin: 0, fontSize: '14px' }}>
              Register as a Volunteer for BNI CHETTINAD Event
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: loading ? 'none' : '0 4px 15px rgba(243, 156, 18, 0.4)',
              }}
              onMouseOver={(e) => {
        ...
        <p style={{
          ...
          Volunteer registrations are complimentary — no payment required.
        </p>
      </div>
    </div>
  )
